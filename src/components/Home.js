...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-[calc(100vh-10cm)] md:top-[calc(100vh-6cm)] left-1/2 transform -translate-x-1/2 w-full max-w-4xl p-4 rounded-full flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4"
        style={{
      ...
      >
        ...
        {/* Vertical Line */}
        <div className="h-8 w-px bg-white mx-2 hidden sm:block"></div>
